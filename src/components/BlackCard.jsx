const BlackCard = ({title, desc, img, alt}) => {
  return (
    <div
      className="relative max-size-96 w-full flex flex-col items-center bg-black pt-10"
    >
      ...
      <div className="absolute max-w-56 bottom-8 left-8 p-2 flex flex-col gap-3 text-[#fafafa]">
