...
const Header = () => {
  ...
  return (
    <header className="w-full h-auto flex flex-col md:flex-row items-stretch justify-center relative shadow z-20 p-2 lg:px-8 bg-white">
      ...
      <div className="flex-1 flex items-center gap-2 py-2 md:hidden ">
        ...
        {location.pathname === "/" ? (
          ...
          >
            <FontAwesomeIcon
              icon={state.CatsMenuOpened ? faTimes : faThLarge}
            />
          </button>
        ) : (
          ""
