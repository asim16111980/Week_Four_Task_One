            ...
            <div className="size-full flex flex-col md:flex-row items-center justify-center bg-black py-3 md:px-4 lg:px-6 gap-6">
              <div className="flex-[50%] p-2">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="font-poppins text-neutral-50 text-xs lg:text-base">
                    iPhone 14 Series
                  </span>
                </div>
                <p className="text-xl md:text-2xl lg:text-5xl text-neutral-50 font-semibold mb-3">
                  Up to 10% off Voucher
                </p>
                <div className="font-poppins flex items-center gap-2 text-neutral-50 text-xs lg:text-base">
